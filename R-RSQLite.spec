...
Source0  : https://cran.r-project.org/src/contrib/RSQLite_2.2.6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618248459
...
/usr/lib64/R/library/RSQLite/icons/sqlite.png
/usr/lib64/R/library/RSQLite/rstudio/connections.dcf
/usr/lib64/R/library/RSQLite/rstudio/connections/SQLite.R
